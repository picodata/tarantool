...
test:execsql([[
   ...
   CREATE TABLE t3(a INTEGER, b INTEGER PRIMARY KEY);
...
-- All commented tests below should be uncommented after porting 72b9fdc
-- commit  from sqlite (add support for RANGE window frames).
--
-- test:do_execsql_test(
--    "1.2",
--    [[
...
--       4, 990, 4, 990, 4, 990, 4, 990, 4, 990, 4, 990, 5, 1010, 5, 1010, 5,
--       1010, 5, 1010, 5, 1010, 5, 1010, 5, 1010, 5, 1010, 5, 1010, 5, 1010, 6,
--       1030, 6, 1030, 6, 1030, 6, 1030, 6, 1030, 6, 1030, 6, 1030, 6, 1030, 6,
--       1030, 6, 1030, 7, 1050, 7, 1050, 7, 1050, 7, 1050, 7, 1050, 7, 1050, 7,
--       1050, 7, 1050, 7, 1050, 7, 1050, 8, 1070, 8, 1070, 8, 1070, 8, 1070, 8,
--       1070, 8, 1070, 8, 1070, 8, 1070, 8, 1070, 8, 1070, 9, 540, 9, 540, 9,
--       540, 9, 540, 9, 540, 9, 540, 9, 540, 9, 540, 9, 540, 9, 540
-- })
...
--    ]], {
--       0, 550, 0, 550, 0, 550, 0, 550, 0, 550, 0, 550, 0, 550, 0, 550, 0, 550,
--       0, 550, 1, 1010, 1, 1010, 1, 1010, 1, 1010, 1, 1010, 1, 1010, 1, 1010, 1,
--       1010, 1, 1010, 1, 1010, 2, 930, 2, 930, 2, 930, 2, 930, 2, 930, 2, 930,
